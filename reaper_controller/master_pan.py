...
PANNING_VALUE = 0.75  # Value in range [-1, 1], where -1.0 represents full left pan, 0 is centered, and 1.0 represents full right pan
...
RPR.SetMediaTrackInfo_Value(master_track, "D_PAN", PANNING_VALUE)
