...
class GenerateSQLQueryPrompt:
    ...
    def run(self, nl_query: str, table_attributes_context: str, reference_values_context: str, sample_data_context: str):
        prompt = self.USER_MESSAGE.format(nl_query=nl_query, table_attributes_context=table_attributes_context, reference_values_context=reference_values_context, sample_data_context=sample_data_context)
